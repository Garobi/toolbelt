...
public class cmpRepPct {
    ...
    public JPanel iniciaComponent(){
        ...
        pnlMod.setBounds(710, 10, 340, 150);
        pnlMod.setBorder(BorderFactory.createTitledBorder("Amostragem - Quanto X% representa de Y"));

        lblNome = new JLabel("Total (a)");
        lblNome.setBounds(10, 25, 110, 25);
        lblNome.setHorizontalAlignment(SwingConstants.RIGHT);
        pnlMod.add(lblNome);

        lblNome = new JLabel("Porcentagem (b)");
        ...
        btnCalcularButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    String resposta = String.valueOf((num1*num2)/100);
